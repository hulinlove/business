          ...
          <div class="layer_menu">
            <ul class='menulist'>
              <li>
                ...
                <span @click="goAddress('/home')">首页</span>
              </li>
              <li>
                <i class="iconfont icon-search"></i>
                <span @click="goAddress('')">搜素</span>
              </li>
              <li>
                <i class="iconfont icon-store"></i>
                <span @click="goAddress('')">店铺</span>
              </li>
              <li>
                <i class="iconfont icon-cart1"></i>
                <span @click="goAddress('/cart')">购物车</span>
              </li>
              <li>
                <i class="iconfont icon-heart"></i>
                <span @click="goAddress('/myCenter')">我的关注</span>
              </li>
            </ul>
          </div>
        </layer>
